...
// void	charstar_args_clean(char **dest)
// {
// 	int	i;
...
// int	nbr_of_arg_element(t_env *env_tmp)
// {
// 	int	nbr;
...
// char	**arg_to_charstar_reconversion(t_cmd *cmd)
// {
// 	int		nbr;
// 	char	**dest;

// 	nbr = nbr_of_arg_element(env_tmp);
...
// 	return (dest);
// }
// WARNING UNUSABLE RIGHT NOW BECAUSE FLAGS EN ARGUMENT ARE SORTED WHICH SHOULDNT BE,UPDATING IN PROCESS
