...
CGASSER_CFILES = ft_parse.c ft_get_type.c ft_tokenize.c ft_split_quoted.c \
		 ft_check_cmd.c ft_list_token.c ft_print_token_list.c \
		 ft_fill_cmd.c ft_lst_cmd.c ft_new_cmd.c ft_free_cmd.c \
		 ft_print_cmd_list.c ft_cmd_cmp.c ft_cmd_cmp_envp.c \
		 ft_get_envpaths.c ft_expand_var.c
